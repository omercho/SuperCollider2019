...
'methods': [ "_-wrapExtend","_-wrapAt","_-asCompileString","_-stutter","_-at","_-asRawOSC","_-normalizeSum","_-clipExtend","_-pyramidg","_-source","_-mirror2","_-asString","_-size","_-put","_-pyramid","_-multiChannelExpand","_-foldPut","_-containsSeqColl","_-normalize","_-plot","_-scramble","_-mirror1","_-slide","_-atIdentityHashInPairs","_-allTuples","_-atIdentityHash","_-reverseDo","_-permute","_-flop","_-foldAt","_-swap","_-powerset","_-clipPut","_-addFirst","_-dpoll","_-clipAt","_-++","_-removeAt","_-mirror","_-envirPairs","_-rotate","_-insert","_-reverse","_-wrapPut","_-isValidUGenInput","_-do","_-deepCollect","_-reshape","_-foldExtend","_-addAll","_-lace","_-collect","_-shift","_-add","_-fork","_-sputter","_-windex","_-replace","_*linrand","_*geom","_*interpolation","_*fill2D","_*fill","_*rand2","_*exprand","_*new","_*fib","_*series","_*iota","_*fillND","_*newClear","_*newFrom","_*with","_*rand","?-prUnarchive","?-proxyControlClass","?-numChannels","?-asAudioRateInput","?-envAt","?-poll","?-asSpec","?-unlace","?-deinterlace","?-interlace","?-prUnlace","?-asControlInput","?-scope","?-asUGenInput","?-madd","?-buildForProxy" ],
'superclasses': [ "ArrayedCollection","SequenceableCollection","Collection","Object" ],
},
"Classes/Monitor": {
'title': "Monitor",
...
'keywords': [  ],
'related': [  ],
'methods': [ "?-keyTime","?*proxy","?*p1","?*counter3","?*new","?*set","?*lng","?*globals","?*lbl","?*oscResp","?*load","?*octave","?*octMul","?*osc","?*makeOSCResponders" ],
'superclasses': [ "Object" ],
},
